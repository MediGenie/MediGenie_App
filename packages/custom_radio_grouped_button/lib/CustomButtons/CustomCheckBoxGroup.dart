...
class CustomCheckBoxGroupState<T> extends State<CustomCheckBoxGroup<T>> {
  ...
  void initState() {
    super.initState();
    widget.checkBoxButtonValues(widget.defaultSelected!);
  ...
  void selectButton(T _selectedValue) {
    if (widget.isDefaultRelease) {
      if (selectedValues.contains(widget.defaultSelected!.first)) {
        selectedValues.remove(widget.defaultSelected!.first);
        if (selectedValues.contains(_selectedValue)) {
          selectedValues.remove(_selectedValue);
        } else {
          selectedValues.add(_selectedValue);
        }
      } else {
        if (selectedValues.contains(_selectedValue)) {
          selectedValues.remove(_selectedValue);
        ...
        if (selectedValues.isEmpty || selectedValues.contains(widget.defaultSelected!.first)) {
          selectedValues.clear();
          selectedValues.add(widget.defaultSelected!.first);
        }
      }
    }
