...
class FormValidation {
  ...
  static String? requiredTextField(String? input) => input.isNotNullOrEmpty() ? null : 'This field cannot be empty';

  /// Implementation of [StringValidator.isValidEmail] for email validation
  static String? emailTextField(String? input) => input.isValidEmail() ? null : 'Invalid Email Address';
}
