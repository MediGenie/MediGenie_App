...
class ApiManager {
  ...
  static Future<ApiCallResponse> urlRequest(
    ...
    if (params.isNotEmpty) {
      ...
      apiUrl = '$apiUrl${needsParamSpecifier ? '?' : ''}${asQueryParams(params)}';
    }
  ...
  static Future<ApiCallResponse> multipartRequest(
    ...
    isFile(e) => e is FFUploadedFile || e is List<FFUploadedFile> || (e is List && e.firstOrNull is FFUploadedFile);
  ...
  Future<ApiCallResponse> makeApiCall({
    ...
    if (_locale != null) {
      headers[HttpHeaders.acceptLanguageHeader] = '${_locale!.languageCode}_${_locale!.countryCode}';
    }
