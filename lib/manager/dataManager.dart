...
class DataManager {
  ...
  MedigenieAIResultServerModel setTempData() {
    ...
    data.average = UIManager.getInstance().currentDiagnosis!.average;
    data.right = UIManager.getInstance().currentDiagnosis!.right;
    data.left = UIManager.getInstance().currentDiagnosis!.left;
